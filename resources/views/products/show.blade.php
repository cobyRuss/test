        ...
        <div class="container">
            ...
            <div style="display:flex;gap:40px;flex-wrap:wrap;background:#fff;border-radius:12px;padding:30px;box-shadow:0 8px 25px rgba(0,0,0,0.08);">
                <div style="flex:1;min-width:300px;">
                    <div class="product-img" style="height:auto;cursor:zoom-in;border-radius:10px;">
                        <img src="{{ asset('images/'.$product->image_url) }}" alt="{{ $product->name }}" style="height:420px;">
                    </div>
                </div>
                <div style="flex:1;min-width:300px;">
                    <p style="color:var(--secondary);font-weight:600;text-transform:uppercase;font-size:0.85rem;">{{ ucfirst($product->category) }}</p>
