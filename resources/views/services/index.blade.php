...
@section('content')
    <section class="page-heading" style="background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('{{ asset('images/aa.jpg') }}') center/cover; color:#fff;">
        <h2>Our Services</h2>
        <p>Floral arrangements and styling for every occasion across Abra.</p>
    </section>
